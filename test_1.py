...
function 1 will calculate the amount for the first option, function 2 will calculate the amount for the second option.
...
if the amount it equal, we output to the user "Option 1 and Option 2 pays the same"
